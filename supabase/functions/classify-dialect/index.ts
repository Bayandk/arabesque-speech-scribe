...
function classifyArabicByKeywords(text: string) {
  const keywords = {
    egyptian: ["إيه", "إزيك", "إزايك", "يلا", "كدة", "أصل", "علشان", "عامل", "ايه"],
    levantine: ["شو", "كيفك", "بدي", "هيك", "مشان", "عم", "شلون", "وين"],
    gulf: ["شلونك", "وش", "ليش", "عاد", "زين", "أبي", "شنو", "وين"],
    maghrebi: ["كيفاش", "شحال", "بغيت", "درت", "مزيان", "واش", "بصح"]
  }
